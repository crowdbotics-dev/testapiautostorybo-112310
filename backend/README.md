...
## Project Structure
    ...
    ├── testapiautostorybo_112310  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_112310`
...
2. Clone this repo and `cd testapiautostorybo_112310`
